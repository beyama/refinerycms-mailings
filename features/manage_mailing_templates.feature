...
Feature: Mailing Templates
  ...
  Scenario: Create Valid Mailing Template
    ...
    And I fill in "Slug" with "default.html"
    And I press "Save"
  ...
  Scenario: Create Invalid Mailing Template (without slug)
    When I go to the list of mailing_templates
    And I follow "Create new template"
    And I press "Save"
    Then I should see "Slug can't be blank"
  ...
  Scenario: Edit Existing Mailing Template
    ...
    Then I fill in "Slug" with "newsletter.html"
    And I press "Save"
  ...
  Scenario: Create Duplicate Mailing Template
    ...
    When I go to the list of mailing_templates
    And I follow "Create new template"
    And I fill in "Slug" with "newsletter.html"
    And I press "Save"
