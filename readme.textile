...
* asynchron email processing through a background job
...
To install, add refinerycms_mailings to your @Gemfile@ and run `bundle install`:

<pre>
gem 'refinerycms_mailings'
</pre>
...
# Check the "GitHub issue tracker":http://github.com/beyama/refinerycms_mailings/issues/ to see if anyone else has reported issue.
